...
const ProgramCard = ({ program, index }) => {
    ...
    return (
        ...
        >
            <div className={`w-16 h-16 rounded-xl bg-linear-to-r ${program.color} p-3 mb-5 group-hover:scale-110 transition-transform duration-300`}>
            ...
            <div className="mt-5 opacity-0 group-hover:opacity-100 transition-opacity">
                <span className="text-lime-400 text-sm font-medium inline-flex items-center gap-1 cursor-pointer">
                    Learn more →
                </span>
            </div>
        </motion.div>
